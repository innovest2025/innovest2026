      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Innovest 2025 is the premier innovation and investment summit that
            brings together the brightest minds, most promising startups, and
            leading investors to shape the future of technology and business.
          </p>
        </div>
        {/* about citbif */}
        <div className="text-center mb-16">
            ...
            <div className="bg-gradient-to-br from-blue-900 to-indigo-800 rounded-2xl p-8 text-white">
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span>
                    Access to exclusive investor networks and funding
                    opportunities
                  </span>
                </li>
                <li className="flex items-start space-x-3">
